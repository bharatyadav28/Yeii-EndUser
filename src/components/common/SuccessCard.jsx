...
const SuccessCard = ({ heading, subHeading, route }) => {
  ...
  return (
    <div className="relative ">
      ...
      <div className="bg-white p-4 pt-16 w-max rounded-3xl flex flex-col justify-center items-center gap-2">
        <div className="text-center font-bold text-3xl w-max text-nowrap mx-10">
          {heading}
        </div>
        ...
        <DarkButton
          ...
          className="w-full m-0 mt-5 text-lg"
        >
          {t("continue")}
        </DarkButton>
      </div>
